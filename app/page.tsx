    ...
    if (inverterActive && !greenPageLoaded) {
      ...
      const preloadGreenPage = async (attempt = 1) => {
        try {
          ...
          console.error(
            `Failed to preload green page (attempt ${attempt}):`,
            error,
          );
          ...
          if (
            ...
            logError(
              "Failed to preload green page after retries",
              error as Error,
            );
          }
        }
    ...
    >
      ...
      <AnimatePresence mode="wait">
        {isLoading && (
          ...
          >
            <div
              className={`flex flex-col items-center ${isDark ? "bg-[#020617]" : "bg-white"}`}
            >
              {/* Animated Logo */}
              <motion.div
              ...
              >
                ...
                <p
                  className={`text-xl leading-relaxed tracking-wide ${isDark ? "text-slate-300" : "text-black"}`}
                >
              ...
              >
                ...
                {!inverterActive && (
                  <div className="flex flex-col items-center justify-center max-w-3xl mx-auto w-full">
                    <GreanCard
                      pattern="dots"
                      gradient
                      className="relative backdrop-blur-sm shadow-xl p-4 overflow-hidden"
                    >
                      ...
                      {/* Section Header */}
                      <h2
                        className={`text-2xl font-bold leading-tight mb-3 drop-shadow-lg tracking-tight text-center ${
                          isDark
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <div className="flex flex-col items-center justify-center mb-2 sm:mb-0">
                          ...
                          <span
                            className={`block mt-1 text-xs font-medium tracking-wide ${
                ...
                {inverterActive && (
                  <>
                    ...
                    <div
                      className={`flex sm:hidden flex-col items-center justify-center max-w-xs mx-auto ${
                        isDark ? "bg-[#020617]" : "bg-white"
                      }`}
                    >
                      <div className="relative group">
                        <div
                          className={`absolute -inset-0.5 bg-gradient-to-r from-[#3DD56D] to-[#2bb757] rounded-lg blur opacity-40 group-hover:opacity-70 transition duration-1000 ${
                    ...
                    <div
                      className={`hidden sm:flex lg:hidden justify-end ${
                        isDark ? "bg-[#020617]" : "bg-white"
                      }`}
                    >
                      <div className="fixed right-2 top-1/2 transform -translate-y-1/2 z-20">
                        <GreanCard
                          pattern="dots"
                          gradient
                          className={`relative backdrop-blur-sm shadow-xl p-3 overflow-hidden w-48 max-h-[80vh] overflow-y-auto ${
                        ...
                        >
                          ...
                          ></div>
                          <div
                            className={`absolute -top-16 -left-16 w-24 h-24 rounded-full ${
                              isDark ? "bg-[#3DD56D]/10" : "bg-[#2bb757]/20"
                            }`}
                          ></div>
                          ...
                          <h3
                            className={`text-sm font-bold leading-tight mb-3 drop-shadow-lg tracking-tight text-center ${
                              isDark
                                ? "text-transparent bg-clip-text bg-gradient-to-r from-[var(--grean-primary)] to-[var(--grean-secondary)]"
                                : "text-[var(--grean-secondary)]"
                            }`}
                          ...
                          <div className="flex flex-col items-center space-y-3">
                            ...
                            <div className="w-full space-y-2 text-xs">
                              <div className="text-center">
                                <div
                                  className={`font-bold ${isDark ? "text-white" : "text-[#2bb757]"}`}
                                >
                                  +251 913 330000
                                </div>
                                <div
                                ...
                                <div
                                  className={`font-medium ${isDark ? "text-gray-300" : "text-[#2bb757]/80"}`}
                                >
                                  sileshi@greanworld.com
                                </div>
                                <div
