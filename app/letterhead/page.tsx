...
Sincerely,`,
  ...
  useEffect(() => {
    ...
    if (savedTemplate) {
      setSelectedTemplate(
        savedTemplate as "professional" | "modern" | "executive",
      );
    }
  }, []);
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1
            className={`typography-display text-4xl md:text-5xl font-bold mb-4 ${isDarkMode ? "text-white" : "text-gray-900"}`}
          >
            GREAN WORLD Letterhead Generator
          </h1>
          <p
            className={`typography-body text-lg ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
          >
        ...
        <Tabs defaultValue="edit" className="w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <GreanCard pattern="waves" gradient className="p-6">
                  <h3
                    className={`typography-h3 text-xl font-bold mb-4 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                  >
                    Actions
                  </h3>
                ...
                <GreanCard pattern="grid" className="p-6">
                  ...
                  <ul
                    className={`typography-body list-disc pl-5 space-y-2 ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                  >
          ...
          <TabsContent value="templates">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              >
                <div className="text-center">
                  ...
                  <h3
                    className={`typography-h3 font-bold mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                  >
                    Professional
                  </h3>
                  <p
                    className={`typography-body text-sm ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                  >
                    Clean, traditional layout perfect for formal business
                    correspondence
                  </p>
                </div>
              </GreanCard>
              ...
              >
                <div className="text-center">
                  ...
                  <p
                    className={`typography-body text-sm ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                  >
                    Contemporary design with enhanced visual elements and
                    patterns
                  </p>
                </div>
              </GreanCard>
              ...
              >
                <div className="text-center">
                  ...
                  <p
                    className={`typography-body text-sm ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                  >
                    Premium layout with sophisticated styling for executive
                    communications
                  </p>
                </div>
              </GreanCard>
            ...
            <GreanCard pattern="radial" gradient className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <h4
                    className={`typography-body font-semibold mb-2 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                  >
                    Professional
                  </h4>
                  <ul
                    className={`typography-small text-sm space-y-1 ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                  >
          ...
          <TabsContent value="preview">
            ...
            <div className="flex justify-center gap-4">
              ...
              <GreanButton
                onClick={() =>
                  copyToClipboard(letterheadRef.current?.innerHTML || "")
                }
                variant="outline"
                size="lg"
                className="flex items-center gap-2"
...
function LetterheadTemplate({
  ...
  return (
    <div
      ...
      style={{ width: "21cm", minHeight: "29.7cm", padding: "2.5cm 2cm" }}
    >
      {/* Header Section */}
      <div className="flex justify-between items-start mb-12">
        <div className="flex items-center">
          ...
          <div>
            <h1 className="typography-display text-3xl font-bold text-[#2bb757] tracking-wide">
              GREAN WORLD
            </h1>
            <p className="typography-body text-sm text-gray-600 font-medium">
              Sustainable Energy Solutions
            </p>
            <p className="typography-small text-xs text-gray-500 mt-1">
              Leading Ethiopia's Energy Transition
            </p>
          </div>
        </div>
        ...
        <div className="text-right text-sm text-gray-600">
          <p className="typography-body font-semibold text-[#2bb757]">
            Head Office
          </p>
      ...
      <div className="mb-8">
        ...
        <div className="border-l-4 border-[#3DD56D] pl-4">
          <p className="typography-h3 font-bold text-gray-900 text-lg">
            {content.name}
          </p>
          <p className="typography-body text-[#2bb757] font-semibold">
            {content.position}
          </p>
          <p className="typography-small text-gray-600 text-sm">
            {content.department}
          </p>
          <p className="typography-small text-gray-600 text-sm mt-1">
            GREAN WORLD
          </p>
          <div className="mt-3 space-y-1">
            <p className="typography-small text-gray-600 text-xs">
              📞 {content.phone}
            </p>
            <p className="typography-small text-gray-600 text-xs">
              ✉️ {content.email}
      ...
      <div className="absolute bottom-8 left-8 right-8">
          ...
          <div className="flex justify-between items-end">
            <div className="text-sm text-gray-600">
              <div className="flex items-center mb-2">
                ...
                <span className="typography-body font-bold text-[#2bb757]">
                  GREAN WORLD
                </span>
              </div>
        ...
        <div className="absolute -bottom-4 -right-4 opacity-10">
          ...
          >
            <path
              d="M120 15L137.32 37.5L120 60L85.36 60L68.04 37.5L85.36 15L120 15Z"
              fill="#3DD56D"
            />
            <path
              d="M90 25L107.32 47.5L90 70L55.36 70L38.04 47.5L55.36 25L90 25Z"
              fill="#2bb757"
              fillOpacity="0.7"
            />
            <path
              d="M110 5L127.32 27.5L110 50L75.36 50L58.04 27.5L75.36 5L110 5Z"
              fill="#23A455"
              fillOpacity="0.5"
            />
            <path
