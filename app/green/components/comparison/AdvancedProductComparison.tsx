...
export function AdvancedProductComparison({
  ...
  const [sortBy, setSortBy] = useState<
    "rating" | "efficiency" | "name" | "power" | "reliability"
  >("rating");
  ...
  const warranties = useMemo(() => {
    const warr = [
      "All",
      ...new Set(
        products.map((p) => p.specifications?.warranty).filter(Boolean),
      ),
    ];
    return warr;
  }, [products]);
  ...
  const comparisonMetrics = useMemo((): ComparisonMetrics => {
    ...
    const mostReliable = products.reduce((best, current) => {
      const currentWarranty = parseFloat(
        current.specifications?.warranty || "0",
      );
  ...
  const filteredProducts = useMemo(() => {
    let filtered = products.filter((product) => {
      ...
      if (
        productPower < filters.powerRange[0] ||
        productPower > filters.powerRange[1]
      ) {
        return false;
      }
      ...
      if (
        ...
        product.specifications?.warranty !== filters.warranty
      ) {
        return false;
      }
  ...
  const comparisonProducts = useMemo(() => {
    return selectedProducts
      .map((id) => products.find((p) => p.name === id))
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            <h2
              className={`typography-display text-5xl md:text-6xl lg:text-7xl text-center ${
          ...
          >
            Use our advanced comparison tool to analyze{" "}
            <span className="text-[#2bb757] font-semibold">
              energy solutions side-by-side
            </span>
            . Filter by specifications, compare features, and find the perfect
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between mb-8">
            ...
            <div className="relative flex-1 max-w-lg">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Search
                  className={`h-5 w-5 ${isDark ? "text-gray-400" : "text-green-600"}`}
                />
              </div>
              <input
                type="text"
              ...
              {searchQuery && (
                ...
                >
                  <X
                    className={`h-4 w-4 ${isDark ? "text-gray-400 hover:text-white" : "text-gray-500 hover:text-gray-700"}`}
                  />
                </button>
              )}
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                ...
                <button
                  onClick={() =>
                    setViewMode((prev) => ({ ...prev, type: "table" }))
                  }
              ...
              >
                ...
                {Object.values(filters).some(
                  (v) =>
                    ...
                    defaultFilters[
                      Object.keys(filters)[
                        Object.values(filters).indexOf(v)
                ...
                <GreanCard pattern="dots" gradient={true} className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {["All Products", "In Stock", "On Sale", "Popular"].map(
                          (status) => (
                            <button
                              key={status}
                              onClick={() =>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          onClick={() =>
                            setFilters({ ...defaultFilters, minRating: 4.5 })
                          }
                          className={`w-full px-3 py-2 text-xs rounded-lg transition-all duration-300 ${
                            isDark
                              ? "bg-slate-700/50 text-gray-300 hover:bg-slate-600 border border-slate-600"
                  ...
                  {(filters.category !== "All" ||
                    ...
                    filters.powerRange[1] < 10000 ||
                    filters.warranty !== "All" ||
                    filters.availability !== "All Products") && (
                    <div
                      className={`p-4 rounded-lg border-l-4 border-[#3DD56D] ${
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          >
                            🎯 {filteredProducts.length} products match your
                            filters
                          </span>
                        </div>
                        <div className="flex flex-wrap gap-2">
              ...
              <GreanCard pattern="radial" gradient={true} className="p-6">
                ...
                >
                  ...
                  >
                    ...
                    <strong>{comparisonMetrics.highestRated}</strong> has the
                    highest customer rating, while{" "}
                    <strong>{comparisonMetrics.mostEfficient}</strong> provides
                    the highest efficiency. Consider your priorities:
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h3
              className={`typography-h3 text-2xl ${
                isDark ? "text-white" : "text-gray-900"
              }`}
            >
            ...
            <div
              className={`typography-small px-3 py-1 rounded-lg ${
                isDark
                  ? "bg-[#3DD56D]/20 text-[#3DD56D]"
                  : "bg-[#2bb757]/20 text-[#2bb757]"
              }`}
            >
              Sorted by: {sortBy} (
            ...
            {filteredProducts.slice(0, 12).map((product) => {
              ...
              return (
                <motion.div
                  ...
                  onClick={() =>
                    canSelect && toggleProductSelection(product.name)
                  }
                >
                    ...
                    <div className="space-y-3">
                      {product.specifications?.power && (
                        ...
                        >
                          ...
                          <span
                            className={`text-sm font-semibold ${isDark ? "text-white" : "text-green-900"}`}
                          >
                            {product.specifications.power}
                          </span>
                        </div>
        ...
        {comparisonProducts.length >= 2 && (
          ...
          >
            <h3
              className={`typography-h1 text-3xl mb-8 text-center ${
                isDark ? "text-white" : "text-gray-900"
              }`}
            >
              Product Comparison
            ...
            <div className="hidden lg:block overflow-x-auto">
              <table
                className={`min-w-full text-sm rounded-3xl border shadow-2xl backdrop-blur-xl divide-y ${
                  isDark
              ...
              >
                ...
                >
                  <tr>
                    ...
                    <th className="px-6 py-6 font-black text-center text-base">
                      Category
                    </th>
                    <th className="px-6 py-6 font-black text-center text-base">
                      Rating
                    ...
                    <th className="px-8 py-6 font-black text-right text-base">
                      Action
                    </th>
                  </tr>
                </thead>
                ...
                >
                  {comparisonProducts.map((product, index) => {
                    const efficiencyPercent = getEfficiencyPercentage(
                      product.specifications?.efficiency,
                    );
                      ...
                      >
                        ...
                        <td className="px-4 py-6">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <div
                                className={`font-black text-lg group-hover:text-[#3DD56D] transition-colors ${
                              ...
                              {product.badge && (
                                <span
                                  className={`text-xs px-2 py-1 rounded-lg font-semibold mt-2 inline-block ${
                                    isDark
                                      ? "bg-[#3DD56D]/20 text-[#2bb757]"
                                      : "bg-green-100 text-green-700"
                                  }`}
                                >
                                  {product.badge}
                        ...
                        <td className="px-3 py-6 text-center">
                          <div className="flex flex-col items-center">
                            ...
                            {efficiencyPercent > 0 && (
                              <div
                                className={`w-20 h-3 rounded-full overflow-hidden backdrop-blur-sm ${
                ...
                >
                  ...
                  <div className="p-6 pb-4">
                    <div className="flex items-center gap-4 mb-6">
                      <div
                        className={`w-20 h-20 rounded-3xl flex items-center justify-center shadow-lg border backdrop-blur-sm ${
                          isDark
                    ...
                    <div
                      className={`rounded-2xl p-6 mb-6 border backdrop-blur-sm ${
                        isDark
                  ...
                  >
                    <div className="grid grid-cols-2 gap-6">
                      {/* Specifications */}
                      <div
                        className={`rounded-2xl p-5 text-center border backdrop-blur-sm ${
                          isDark
                    ...
                    {product.specifications?.efficiency && (
                      <div
                        className={`rounded-2xl p-5 text-center border backdrop-blur-sm mt-6 ${
                          isDark
                            ? "bg-gradient-to-br from-slate-700/80 to-slate-800/80 border-slate-600"
                            : "bg-gradient-to-br from-[#3DD56D]/10 to-white/80 border-[#3DD56D]/30"
                        }`}
                        ...
                        {getEfficiencyPercentage(
                          ...
                          >
                            <div
                              className="h-full bg-gradient-to-r from-[#3DD56D] to-[#2bb757] rounded-full shadow-inner"
                              style={{
                                width: `${getEfficiencyPercentage(product.specifications.efficiency)}%`,
                              }}
                            ></div>
                          </div>
                        )}
