  ...
  ({
    ...
    <ul className="space-y-2 mb-6">
      {features.map((feature, idx) => (
        ...
        >
          <CheckCircle
            className={`w-4 h-4 mt-0.5 flex-shrink-0 ${accentColor}`}
          />
...
const StatsDisplay = memo(
  ({
    ...
    <div
      className={`inline-flex items-center space-x-2 px-3 py-2 rounded-full ${bgAccent} backdrop-blur-sm`}
    >
      <span className={`text-lg font-bold ${accentColor}`}>{stats.value}</span>
      <span
        className={`text-xs font-medium ${isDark ? "text-gray-300" : "text-description-text"}`}
      >
        {stats.label}
      </span>
    </div>
...
export const IntegratedSolutionCard = memo<IntegratedSolutionCardProps>(
  ({ solution, index, onLearnMore, className = "", priority = "normal" }) => {
    const [isHovered, setIsHovered] = useState(false);
    const [imageLoaded, setImageLoaded] = useState(false);

    const { isLowPerformance, shouldReduceAnimations } =
        ...
        {isCommunityCard && !isLowPerformance && (
          <>
            ...
            <motion.div
              ...
              style={{
                filter:
                  "drop-shadow(0 0 20px rgba(61, 213, 109, 0.8)) drop-shadow(0 0 40px rgba(61, 213, 109, 0.4))",
              }}
            >
              <svg className="w-full h-full" viewBox="0 0 100 100">
                <defs>
                  <linearGradient
                    id="communityRingOuter"
                    x1="0%"
                    y1="0%"
                    x2="100%"
                    y2="100%"
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    right: `${8 + x}px`,
                    filter:
                      "drop-shadow(0 0 10px rgba(61, 213, 109, 0.9)) drop-shadow(0 0 20px rgba(61, 213, 109, 0.6))",
                    mixBlendMode: "screen",
                  }}
                  animate={{
                    scale: [0.8, 2, 0.8],
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(61, 213, 109, 0.3) 0%, rgba(61, 213, 109, 0.1) 50%, transparent 80%)",
                mixBlendMode: "screen",
                filter: "blur(1px)",
              }}
              animate={{
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(43, 183, 87, 0.25) 0%, rgba(35, 164, 85, 0.1) 50%, transparent 80%)",
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(61, 213, 109, 0.5) 0%, rgba(43, 183, 87, 0.3) 50%, transparent 70%)",
            ...
            <motion.div
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, rgba(61, 213, 109, 0.6), rgba(43, 183, 87, 0.5), rgba(35, 164, 85, 0.6)) border-box",
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(45deg, transparent 0%, rgba(61, 213, 109, 0.1) 50%, transparent 100%)",
                mixBlendMode: "screen",
              }}
              animate={{
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(61, 213, 109, 0.4) 0%, transparent 70%)",
                mixBlendMode: "screen",
              }}
              animate={{
                scale: [0, 2, 0],
        ...
        <div className="relative z-10 p-6 sm:p-8 h-full flex flex-col">
          ...
          <div className="mt-auto">
            ...
            >
              ...
              <Play
                className={`w-4 h-4 group-hover/btn:scale-110 transition-transform relative z-10 ${
                  isCommunityCard
                    ? "drop-shadow-[0_0_4px_rgba(61,213,109,0.6)]"
                    : ""
                }`}
              />
