  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setSubmitMessage(
          "✅ Message sent successfully! We will get back to you within 24 hours. Check your email for confirmation.",
        );
        ...
        if (response.status === 400) {
          setSubmitMessage(
            `❌ Form validation failed: ${result.error || "Please check your input and try again."}`,
          );
        } else if (response.status === 500) {
          setSubmitMessage(
            "❌ Server error occurred. Please try again later or contact us directly at info@greanworld.com",
          );
        } else {
          setSubmitMessage(
      ...
      if (error instanceof TypeError && error.message.includes("fetch")) {
        ...
        setSubmitMessage(
          "❌ An unexpected error occurred. Please try again or contact us directly at info@greanworld.com",
        );
      }
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className={`absolute top-40 right-20 w-24 h-24 rounded-full opacity-15 animate-bounce ${
            isDark ? "bg-[#3DD56D]" : "bg-[#2bb757]"
          }`}
        ...
        ></div>
        <div
          className={`absolute bottom-20 right-1/3 w-28 h-28 rounded-full opacity-25 animate-bounce ${
            isDark ? "bg-[#3DD56D]" : "bg-[#2bb757]"
          }`}
      ...
      <div className="max-w-6xl mx-auto text-center mb-8 lg:mb-12 relative z-10">
        <div
          className={`inline-flex items-center rounded-full px-6 py-3 text-sm font-medium mb-6 shadow-xl typography-small backdrop-blur-sm ${
            isDark
        ...
        <div className="mb-6">
          <h1
            className={`text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-tight tracking-tight text-center ${
        ...
        >
          Ready to power your future with sustainable energy? Our expert team is
          here to guide you through solar solutions, clean cooking technologies,
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  <div
                    className={`space-y-2 transition-all duration-300 ${
                      formFields.hasAnimated
                        ? formFields.isIntersecting
                          ? "field-fade-in"
                          : "card-hidden"
                        : "card-hidden"
                    }`}
                    style={{
                      animationDelay: formFields.hasAnimated ? "0.1s" : "0s",
                    }}
                  >
                    <label
                  ...
                  <div
                    ...
                    style={{
                      animationDelay: formFields.hasAnimated ? "0.2s" : "0s",
                    }}
                  >
                    <label
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <option value="clean-cooking-stoves">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        {submitStatus === "error" && (
                          ...
                          >
                            💡 Need immediate help? Call us at (+251) 913 330000
                            or email info@greanworld.com
                          </div>
                        )}
                      </div>
                      <button
                ...
                <div ref={contactButtons.ref} className="pt-4">
                  <button
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start group hover:scale-105 transition-transform duration-300">
                    ...
                    <div className="flex-1">
                      ...
                      >
                        Kirkos Sub City Wereda 02, Deberezeit road, Sierra Leone
                        street, Tegene Building (Global Hotel), 6th floor Addis
                        Ababa, Ethiopia
                      </p>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.google.com/maps/place/8.993709903183268,38.759761667193374/@8.993709903183268,38.759761667193374,17z",
                      "_blank",
                    )
                  }
                >
                  ...
                  <div className="absolute inset-0">
                    {/* Street-like lines */}
                    <div
                      className={`absolute top-1/4 left-0 right-0 h-1 ${isDark ? "bg-slate-500/40" : "bg-green-300/60"} transform rotate-12`}
                    ></div>
                    <div
                      className={`absolute top-3/4 left-0 right-0 h-1 ${isDark ? "bg-slate-500/40" : "bg-green-300/60"} transform -rotate-6`}
                    ></div>
                    <div
                      className={`absolute top-0 bottom-0 left-1/3 w-1 ${isDark ? "bg-slate-500/40" : "bg-green-300/60"} transform rotate-3`}
                    ></div>
                    <div
                      className={`absolute top-0 bottom-0 right-1/4 w-1 ${isDark ? "bg-slate-500/40" : "bg-green-300/60"} transform -rotate-2`}
                    ></div>
                  </div>
                  ...
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20">
                    <div className="relative">
                      ...
                      {/* Company badge */}
                      <div
                        className={`absolute -bottom-8 left-1/2 transform -translate-x-1/2 px-3 py-1 rounded-full text-xs font-bold shadow-lg border-2 whitespace-nowrap ${
                          isDark
                  ...
                  <div
                    className={`absolute top-4 left-4 right-4 backdrop-blur-sm rounded-xl p-4 shadow-lg border transition-all duration-300 ${
                      isDark
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h4 className="font-bold text-lg mb-1 text-[#3DD56D]">
                          GREAN WORLD HQ
                        </h4>
                        <p
                      ...
                      <div className="ml-4">
                        <button
                          onClick={(e) => {
                            e.stopPropagation();
                            window.open(
                              "https://www.google.com/maps/dir/?api=1&destination=8.993709903183268,38.759761667193374",
                              "_blank",
                            );
                          }}
                  ...
                  {/* Bottom Action Bar */}
                  <div
                    className={`absolute bottom-4 left-4 right-4 backdrop-blur-sm rounded-xl p-3 shadow-lg border transition-all duration-300 ${
                      isDark
