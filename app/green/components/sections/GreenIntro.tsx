      ...
      {!loadingComplete && !prefersReducedMotion && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center justify-center mb-12">
            ...
            <h1
              className={`text-3xl md:text-4xl font-extrabold text-center typography-h1 ${
          ...
          <div
            className={`relative w-64 h-1 rounded-full overflow-hidden mb-4 ${
          ...
          <div
            className={`text-sm font-mono typography-small ${
              isDarkMode ? "text-grean-primary" : "text-grean-secondary"
            }`}
          >
            Loading Green Energy... {Math.round(loadingProgress)}%
          </div>

          {/* Solar panel animation */}
          <div className="mt-8 relative">
            <div
              className={`w-32 h-32 border-2 rounded-lg relative overflow-hidden ${
                isDarkMode
            ...
            <div
              className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-4 h-8 border rounded-b-lg ${
                isDarkMode
                ...
                >
                  ...
                  <span
                    className={`inline-block w-2 h-[0.8em] ml-1 align-middle ${
                      ...
                      titleAnimation.isTyping && animationsStarted
                        ? "animate-blink"
                        : "opacity-0"
                    }`}
                  ></span>
                ...
                >
                  ...
                  <span
                    className={`inline-block w-1 h-[0.8em] ml-1 align-middle ${
                      ...
                      taglineAnimation.isTyping && animationsStarted
                        ? "animate-blink"
                        : "opacity-0"
                    }`}
                  ></span>
