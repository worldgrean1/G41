    ...
    >
      ...
      >
        ...
        >
          <span className="text-[#2bb757] font-semibold">
            Clean, accessible, and sustainable energy
          </span>{" "}
          for all communities.
        </motion.p>
      </motion.div>
              ...
              <div className="flex-grow flex flex-col justify-between space-y-3 sm:space-y-4 md:space-y-6 px-4 sm:px-6 lg:px-8 lg:pr-12 pb-4 sm:pb-6 lg:pb-8 min-h-[500px]">
                ...
                >
                  <div className="relative z-10">
                    ...
                    <h4 className="typography-h3 mb-2 sm:mb-3 text-white">
                      Circular Economy Business Model
                    </h4>
                    <p className="typography-body text-white/90">
                      Our innovative circular economy framework helps businesses
                      reduce waste by{" "}
                      <span className="text-[#3dd56d] font-semibold">85%</span>,
                      cut costs by{" "}
                      <span className="text-[#3dd56d] font-semibold">35%</span>,
                      and improve sustainability metrics while maintaining
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <GreanCard className="p-3 sm:p-4 rounded-lg bg-slate-800/50 backdrop-blur-sm border border-slate-700">
                    ...
                    <ul className="typography-small space-y-1 sm:space-y-2 list-disc list-inside text-slate-300">
                      <li>
                        <span className="text-[#2bb757]">10Wp-350Wp</span> solar
                        home systems
                      </li>
      ...
      >
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl typography-display text-center mb-6 ${
              isDark ? "text-white" : "text-gray-900"
            }`}
          >
          ...
          <p
            className={`text-lg sm:text-xl typography-body text-center max-w-3xl mx-auto ${
              isDark ? "text-gray-300" : "text-gray-700"
            }`}
          >
            Innovative{" "}
            ...
            connecting rural communities with sustainable energy through
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div
            className={`relative p-6 sm:p-8 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 ${
              distributionCards.hasAnimated
                ? distributionCards.isIntersecting
                  ? "card-slide-in-left"
                  : "card-slide-out-left"
                : "card-hidden"
            }`}
          ...
          >
            ...
            <div className="relative z-10 text-center text-white">
              ...
              <h3 className="typography-h3 mb-3 text-white">
                Local Partnerships
              </h3>
              <p className="typography-body text-white/90 mb-4">
                Working with{" "}
                <span className="font-semibold">200+ local agents</span> across
                rural Ethiopia to ensure reliable distribution and maintenance
                support.
              </p>
              <div className="text-2xl font-bold text-white">200+</div>
              <div className="typography-small text-white/80">
                Active Partners
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="relative z-10 text-center text-white">
              ...
              <p className="typography-body text-white/90 mb-4">
                ...
                <span className="font-semibold">mobile units</span> and regional
          ...
          >
            ...
            <div className="relative z-10 text-center text-white">
              ...
              <p className="typography-body text-white/90 mb-4">
                Online ordering and{" "}
                <span className="font-semibold">mobile app</span> for easy
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12">
          ...
          >
            <div className="text-4xl sm:text-5xl font-bold text-[#3dd56d] mb-2">
              270k+
            </div>
            <div className="typography-h3 mb-2 text-gray-900 dark:text-white">
              Solar Systems
            </div>
            <div className="typography-small text-gray-600 dark:text-gray-400">
              Deployed across Ethiopia
            </div>
          </GreanCard>
          ...
          >
            <div className="text-4xl sm:text-5xl font-bold text-[#2bb757] mb-2">
              500+
            </div>
            <div className="typography-h3 mb-2 text-gray-900 dark:text-white">
              Villages
          ...
          >
            <div className="text-4xl sm:text-5xl font-bold text-[#23a455] mb-2">
              1.2M
            </div>
            <div className="typography-h3 mb-2 text-gray-900 dark:text-white">
              People
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <h3 className="typography-h3 mb-4 text-[#3dd56d]">
            ...
            <p className="typography-body mb-4 text-gray-700 dark:text-gray-300">
              ...
              to start and grow their businesses, creating sustainable income
              streams in rural communities.
            </p>
          ...
          >
            <h3 className="typography-h3 mb-4 text-[#2bb757]">
              Educational Impact
            </h3>
            <p className="typography-body mb-4 text-gray-700 dark:text-gray-300">
              Solar lighting has extended study hours for{" "}
              <span className="text-[#3dd56d] font-semibold">
                50,000+ students
              </span>
      ...
      >
        <div className="text-center mb-12 sm:mb-16">
          ...
          >
            ...
            where every Ethiopian community has access to clean, reliable, and
            affordable power.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-white">
            <h3 className="text-2xl sm:text-3xl md:text-4xl typography-display mb-6 text-white">
              Transforming <span className="text-yellow-300">20 Villages</span>{" "}
              by 2030
            </h3>

            <p className="text-lg sm:text-xl typography-body mb-8 text-white/90">
              Our ambitious goal is to create 20 fully sustainable green
              villages, each powered entirely by renewable energy and serving as
              models for rural development across Africa.
            </p>
