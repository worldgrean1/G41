  ...
  return useMemo(
    () => ({
      ...
      integratedSolutions: solutionData.integratedSolutions.map((solution) => ({
        ...solution,
        icon:
          solution.title === "Community Solar Projects"
            ? SunMedium
            : solution.title === "Commercial Energy Transition"
              ? Building2
              : solution.title === "Workforce Development"
                ? GraduationCap
                : solution.title === "Sustainable Campus Initiative"
                  ? School
                  : solution.title === "Rural Electrification Program"
                    ? Zap
                    : solution.title === "Women Entrepreneurship Program"
                      ? Users
        ...
        <div className="max-w-7xl mx-auto">
          <div className="solutions-container">
            ...
            <div
              ...
              style={{
                animationDelay: pillarsCards.hasAnimated ? "0.3s" : "0s",
              }}
            >
              <EnergyPillars />
            </div>
