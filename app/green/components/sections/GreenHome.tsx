        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          ...
          >
            ...
            <div className="space-y-6">
              <h1
                className={`text-6xl md:text-7xl lg:text-8xl font-black leading-none tracking-tight flex flex-col sm:flex-row items-center justify-center gap-2 ${
              ...
              <div className="space-y-4">
                <p className="text-xl typography-h3 text-[#2bb757]">
                  ...
                  into Green Villages by 2030.
                </p>
                <p
                  className={`text-lg max-w-2xl typography-body ${
                    isDarkMode ? "text-gray-300" : "text-gray-700"
                  }`}
                >
                  Leading Ethiopia's energy transition with{" "}
                  <span className={`font-semibold text-[#23a455]`}>
            ...
            >
              ...
              <div className="flex space-x-4">
                {[SunMedium, Leaf, Wind, Zap].map((Icon, index) => (
                  ...
                  >
                    <Icon
                      className={`h-5 w-5 ${isDark ? "text-[#3dd56d]" : "text-[#2bb757]"}`}
                    />
                  </div>
                ))}
              </div>
