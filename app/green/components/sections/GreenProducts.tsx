              ...
              <div className="space-y-4 sm:space-y-6">
                <div>
                  ...
                  <p className="text-base sm:text-lg font-medium text-slate-300">
                    Our flagship solar home system with everything needed to
                    power a small household, including lighting, phone charging,
                    and TV capability.
                  </p>
                </div>
    ...
    >
      <div className="w-full flex flex-col items-center max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto text-center mt-2 sm:mt-4 lg:mt-6 mb-6 sm:mb-8 lg:mb-10 relative z-10">
          <div
            className={`inline-flex items-center rounded-full px-4 py-2 text-sm font-medium mb-4 shadow-lg typography-small ${
              isDark
        ...
        <div
          ...
          className={`transition-all duration-300 ${
            mirtStoveSection.hasAnimated
              ? mirtStoveSection.isIntersecting
                ? "card-slide-up-elastic"
                : "card-slide-down"
              : "card-hidden"
          }`}
          style={{
            animationDelay: mirtStoveSection.hasAnimated ? "0.2s" : "0s",
          }}
        >
          <MirtStoveCard />
        </div>
        ...
        >
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="text-center mb-12 sm:mb-16">
              ...
              >
                Browse Our <span className="text-[#3DD56D]">Collection</span>
              </motion.h2>
              ...
              >
                ...
                >
                  Discover sustainable energy solutions that power communities
            ...
            >
              ...
              <div className="mb-8">
                <div className="flex flex-col lg:flex-row gap-6 items-center justify-center">
                  ...
                  >
                    <div className="text-center">
                      <div
                        className={`text-lg font-bold ${isDark ? "text-[#3DD56D]" : "text-green-700"}`}
                      >
                        {filteredProducts.length}
                      </div>
                      <div
                        className={`text-xs ${isDark ? "text-gray-400" : "text-green-600"}`}
                      >
                        Products
                      </div>
                    </div>
                    <div
                      className={`w-px h-8 ${isDark ? "bg-slate-700" : "bg-green-200"}`}
                    />
                    <div className="text-center">
                      <div
                        className={`text-lg font-bold ${isDark ? "text-[#3DD56D]" : "text-green-700"}`}
              ...
              <div className="text-center">
                <div className="inline-flex items-center gap-3 mb-8">
                  <div
                    className={`p-2 rounded-xl ${isDark ? "bg-[#3DD56D]/20" : "bg-green-100"}`}
                  >
                    <Filter
                      className={`h-5 w-5 ${
                ...
                <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
                  {Object.keys(categoryMapping).map((cat) => {
                    ...
                    const categoryStyle =
                      cat !== "All"
                        ? getCategoryStyle(
                            categoryMapping[cat][0] || "advisory",
                            isDark,
                          )
                        : null;
                    ...
                    return (
                      ...
                      >
                        {categoryStyle?.icon && (
                          <span
                            className={
                              isActive ? "text-white" : categoryStyle.text
                            }
                          >
                            {categoryStyle.icon}
                          </span>
                ...
                <div className="mt-6">
                  <div
                    className={`inline-flex items-center gap-3 px-6 py-3 rounded-2xl backdrop-blur-sm ${
                      isDark
                  ...
                  >
                    ...
                    {isLoadingFullData && (
                      <div className="inline-flex items-center gap-2">
                        ...
                        <span
                          className={`text-sm ${isDark ? "text-gray-400" : "text-green-600"}`}
                        >
                          Loading...
                        </span>
                      </div>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        animationDelay: productGrid.hasAnimated
                          ? `${idx * 0.1}s`
                          : "0s",
                      }}
                    >
                      ...
                      <div className="p-4 pb-2 relative flex-shrink-0">
                        ...
                        >
                          ...
                          {categoryStyle.icon &&
                            React.isValidElement(categoryStyle.icon) &&
                            React.cloneElement(
                              categoryStyle.icon as React.ReactElement<any>,
                              {
                                className:
                      ...
                      <div className="p-4 pt-1 flex-grow flex flex-col">
                        <h3
                          className={`typography-h3 text-lg sm:text-xl mb-2 text-center leading-tight line-clamp-2 ${
                            isDark ? "text-white" : "text-gray-900"
                          }`}
                        >
                          {product.name}
                        ...
                        <p
                          className={`typography-body text-sm text-center mb-3 leading-relaxed line-clamp-2 ${
                        ...
                        <div className="mb-4">
                          <div
                            className={`flex items-center gap-2 mb-2 font-bold text-sm ${categoryStyle.text}`}
                          >
                          ...
                          <div className="space-y-2">
                            {product.specifications?.efficiency && (
                              ...
                              >
                                ...
                                <span
                                  className={`text-sm font-bold ${categoryStyle.text}`}
                                >
                                  {product.specifications.efficiency}
                                </span>
                              </motion.div>
                      ...
                      <div
                        className={`px-4 pb-4 border-t backdrop-blur-sm flex-shrink-0 ${
                          isDark
                      ...
                      >
                        <div className="flex flex-wrap gap-2 pt-3 items-center justify-between">
                          ...
                          {/* Category Icon */}
                          <div
                            className={`w-8 h-8 rounded-lg flex items-center justify-center bg-gradient-to-br ${categoryStyle.gradient} shadow-lg`}
                          >
                            {categoryStyle.icon &&
                              React.isValidElement(categoryStyle.icon) &&
                              React.cloneElement(
            ...
            >
              ...
              >
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 group-hover:rotate-45 ${
                    isDark
                      ? "bg-[#3DD56D]/30 group-hover:bg-[#3DD56D]/50"
              ...
              >
                <div
                  className={`flex flex-col items-center gap-3 p-6 rounded-2xl backdrop-blur-sm ${
                    isDark
                      ? "bg-slate-800/50 border border-slate-700/50"
                      : "bg-green-50/80 border border-green-200/50"
                  }`}
                >
                  ...
                  <div className="text-center">
                    <div
                      className={`text-2xl font-bold ${isDark ? "text-white" : "text-green-900"}`}
                    >
                      {filteredProducts.length}+
                    </div>
                    <div
                      className={`text-sm font-medium ${isDark ? "text-gray-400" : "text-green-600"}`}
                    >
                      Products Available
                    </div>
                  </div>
        ...
        <div
          ...
          className={`transition-all duration-300 ${
            comparisonSection.hasAnimated
              ? comparisonSection.isIntersecting
                ? "card-fade-in-scale"
                : "card-slide-down"
              : "card-hidden"
          }`}
          style={{
            animationDelay: comparisonSection.hasAnimated ? "0.4s" : "0s",
          }}
        >
          <AdvancedProductComparison products={products} className="" />
        </div>
      </div>
    </div>
  );
