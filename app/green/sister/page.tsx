    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <Image
                src={sisterLogo}
                alt="Ethio Renewable Energy Solutions"
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-4xl mx-auto leading-relaxed">
            Powering Ethiopia with sustainable and affordable clean energy
            solutions. From solar systems to clean cookstoves, we're building a
          ...
          <div className="animate-bounce">
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="lucide lucide-chevron-down w-8 h-8 text-green-600 mx-auto"
            >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Empowering Ethiopia with{" "}
              <span className="text-green-600">Clean Energy</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Founded in 2024, we're an independent Ethiopian company dedicated
              to providing sustainable and affordable clean energy solutions
              that transform communities and protect our environment.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-green-50 to-green-100 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                Independent Ethiopian business focused on sustainable energy
                solutions
              </p>
            </div>
            <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-yellow-50 to-yellow-100 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                Empowering rural and urban communities across Ethiopia
              </p>
            </div>
            <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 hover:shadow-lg transition-all duration-300">
              <div className="w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-sun w-8 h-8 text-white"
                >
              ...
              <p className="text-gray-600">
                Building a sustainable tomorrow with renewable energy
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-green-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Our <span className="text-green-600">Services & Solutions</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive renewable energy services designed to meet the
              diverse needs of Ethiopian communities
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <div className="text-white">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-sun w-8 h-8"
                  >
                    <circle cx="12" cy="12" r="4"></circle>
                    <path d="M12 2v2"></path>
                    <path d="M12 20v2"></path>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                and backup systems for homes and businesses.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <div className="text-white">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-wrench w-8 h-8"
                  >
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                ensure optimal performance of your energy systems.
              </p>
            </div>
            {/* Energy Consultation */}
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <div className="text-white">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-lightbulb w-8 h-8"
                  >
              ...
              <p className="text-gray-600 leading-relaxed">
                Expert consultation on renewable energy solutions and energy
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Comprehensive warranty services and technical assistance to keep
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Educational programs for customers, technicians, and partners to
                maximize clean energy adoption.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Tailored solutions for households, institutions, and productive
                use applications.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Why Choose{" "}
              <span className="text-green-600">Ethio Renewable?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We combine local expertise with global standards to deliver
              exceptional renewable energy solutions
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex items-start gap-4 p-6 rounded-xl hover:bg-green-50 transition-all duration-300 group">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  Locally Driven, Impact-Focused
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  Deep understanding of Ethiopia's energy needs with tailored
                  solutions for both rural and urban communities.
                </p>
              </div>
            </div>
            {/* Wide Product Range */}
            <div className="flex items-start gap-4 p-6 rounded-xl hover:bg-green-50 transition-all duration-300 group">
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0 group-hover:bg-green-200 transition-colors duration-300">
                <div className="text-green-600">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-battery w-6 h-6"
                  >
                    <rect
                      width="16"
                      height="10"
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  From solar panels to cookstoves, backup systems, water
                  heaters, irrigation, and DC appliances – all under one roof.
                </p>
              </div>
            </div>
            {/* End-to-End Services */}
            <div className="flex items-start gap-4 p-6 rounded-xl hover:bg-green-50 transition-all duration-300 group">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Complete solutions – consultation, installation, training, and
            ...
            <div className="flex items-start gap-4 p-6 rounded-xl hover:bg-green-50 transition-all duration-300 group">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Focus on women empowerment, productive use, and clean energy
                  access to uplift livelihoods.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 rounded-xl hover:bg-green-50 transition-all duration-300 group">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Innovative models like Pay-As-You-Go (PAYGO) and partnerships
            ...
            <div className="flex items-start gap-4 p-6 rounded-xl hover:bg-green-50 transition-all duration-300 group">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Trusted products and services backed by warranty and
                  continuous support.
                </p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-green-700">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-green-100 mb-8 leading-relaxed">
            Join thousands of Ethiopians who have already made the switch to
            clean, affordable energy. Get your free consultation today and start
            saving while protecting the environment.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Visit our store, call us, or reach out online. We're here to help
              you find the perfect energy solution.
            </p>
          </div>
            ...
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-map-pin w-8 h-8 text-green-600"
                >
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Lemi Kura Sub-City, In front of Police Station, Addis Ababa,
                Ethiopia
              </p>
            </div>
            {/* Phone */}
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-phone w-8 h-8 text-green-600"
                >
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                </svg>
              </div>
            ...
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-mail w-8 h-8 text-green-600"
                >
            ...
            <div className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="lucide lucide-clock w-8 h-8 text-green-600"
                >
                  <circle cx="12" cy="12" r="10"></circle>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <svg
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="lucide lucide-check-circle w-5 h-5 text-green-600"
                    >
                      <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                      <path d="m9 11 3 3L22 4"></path>
                    </svg>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-bold mb-4">
              Ethio Renewable Energy Solution PLC
            </h3>
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              Empowering Ethiopia with sustainable and affordable clean energy
              solutions. Building a brighter, cleaner future for all
              communities.
            </p>
            <div className="flex justify-center gap-6 text-sm text-gray-400">
              <span>
                Follow us on TikTok: @Ethio_renewable_energy_solutions
              </span>
            </div>
            <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-500">
              <p>
                © 2024 Ethio Renewable Energy Solution PLC. All rights
                reserved.
              </p>
            </div>
          </div>
