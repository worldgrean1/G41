              ...
              <li key={index} className="relative group">
                ...
                `}
                  >
                    {/* Compact Tooltip */}
                    <div
                      className={`backdrop-blur-sm rounded-lg px-3 py-2 shadow-xl border ${
                        isDark
