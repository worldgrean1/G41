        ...
        <div className="flex flex-col lg:flex-row relative z-10">
          ...
          <div className="w-full lg:w-[45%] relative overflow-hidden min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] p-4">
            ...
            <div className="relative z-10 w-full h-full flex items-center justify-center">
              <div
                className="relative"
                style={{ width: "320px", height: "472px" }}
              >
                <StaticInverterNode
          ...
          <div className="w-full lg:w-[55%] p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
            <div className="space-y-4 sm:space-y-6">
              <div>
                <Badge className="mb-3 bg-gradient-to-r from-[#3DD56D] to-[#2bb757] text-white border-[#3DD56D]/30 shadow-lg shadow-[#3DD56D]/20">
                  Interactive Demo
                </Badge>
                ...
                <p className="text-base sm:text-lg font-medium text-slate-300">
                  Interact with our advanced inverter simulation featuring
                  real-time monitoring, multiple operating modes, and
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mt-2 gap-4 flex-shrink-0">
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  <Badge
                    variant="outline"
                    className="border-[#3DD56D] text-[#3DD56D] bg-transparent hover:bg-[#3DD56D]/10"
                  >
                    #SmartInverter
                  </Badge>
                  <Badge
                    variant="outline"
                    className="border-[#2bb757] text-[#2bb757] bg-transparent hover:bg-[#2bb757]/10"
                  >
                    #Interactive
                  </Badge>
                  <Badge
                    variant="outline"
                    className="border-[#23A455] text-[#23A455] bg-transparent hover:bg-[#23A455]/10"
                  >
                    #RealTime
                  </Badge>
                </div>
