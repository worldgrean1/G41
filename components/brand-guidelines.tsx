...
const ColorSwatch: React.FC<ColorSwatchProps> = ({
  ...
  return (
    <div
      className={`${isDarkMode ? "bg-slate-900/80 border-slate-700" : "bg-white border-gray-200"} p-6 rounded-xl border group hover:${isDarkMode ? "bg-slate-800/80" : "bg-gray-50"} transition-all duration-300`}
    >
      <div
        className="w-full h-40 rounded-xl mb-6 shadow-lg group-hover:scale-105 transition-transform duration-300"
        style={{
          backgroundColor: color.hex,
          boxShadow: `0 10px 30px ${color.hex}20`,
        }}
      />
  ...
  return (
    <div className={themeClasses}>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link
                href="/"
                className={`flex items-center gap-2 text-sm ${isDarkMode ? "text-gray-500 hover:text-gray-300" : "text-gray-600 hover:text-gray-800"}`}
              >
                <ArrowLeft className="h-4 w-4" />
                Back to Website
              </Link>
              <div
                className={`h-6 w-px ${isDarkMode ? "bg-gray-600" : "bg-gray-300"}`}
              />
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                variant="outline"
                size="sm"
                className="bg-gradient-to-r from-[#3DD56D] to-[#2bb757] text-white border-none hover:shadow-lg hover:shadow-[#3DD56D]/20"
              >
      ...
      <div className="flex">
        {/* Sidebar Navigation */}
        <aside
          className={`hidden lg:block w-64 ${isDarkMode ? "bg-slate-900/50" : "bg-gray-50/50"} border-r ${isDarkMode ? "border-slate-800" : "border-gray-200"} sticky top-[73px] h-[calc(100vh-73px)] overflow-y-auto`}
        >
          <div className="p-6">
            <h3
              className={`text-sm font-semibold ${isDarkMode ? "text-slate-400" : "text-gray-600"} uppercase tracking-wider mb-4`}
            >
              Navigation
            </h3>
            <nav className="space-y-2">
              <a
                href="#overview"
                className={`block px-4 py-2 rounded-lg transition-colors text-sm ${isDarkMode ? "text-slate-300 hover:bg-slate-800 hover:text-white" : "text-gray-700 hover:bg-gray-100 hover:text-gray-900"}`}
              >
                Overview
              </a>
              <a
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
            ...
            <section id="overview" className="space-y-8">
              <div style={{ opacity: 1, transform: "none" }}>
                <div className="text-center mb-12">
                  <h2
                    className={`text-5xl font-black mb-6 ${isDarkMode ? "text-white" : "text-gray-900"}`}
                  >
                    Brand <span className="text-[#3DD56D]">Overview</span>
                  </h2>
                  <p
                    className={`text-xl max-w-3xl mx-auto leading-relaxed ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                  >
                    GREAN WORLD represents Ethiopia's sustainable energy
                    revolution, combining innovation with environmental
                    responsibility to power communities across the nation. Our
                    visual identity reflects our commitment to clean energy,
                ...
                <div
                  className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-8 mb-8`}
                >
                  <h3
                    className={`text-3xl font-bold ${isDarkMode ? "text-white" : "text-gray-900"} mb-8 text-center`}
                  >
                    Brand Logo
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="text-center">
                      <div
                        className={`${isDarkMode ? "bg-slate-800" : "bg-gray-100"} rounded-2xl p-8 mb-6`}
                      >
                        <Image
                      ...
                      <h4
                        className={`font-bold ${isDarkMode ? "text-white" : "text-gray-900"} mb-3 text-lg`}
                      >
                        Primary Logo
                      </h4>
                      <p
                        className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                      >
                        Stylized green earth with flowing energy elements
                        representing global sustainability and renewable energy
                        flow.
                      </p>
                    </div>
                    <div className="text-center">
                      <div
                        className={`${isDarkMode ? "bg-white" : "bg-gray-50"} rounded-2xl p-8 mb-6`}
                      >
                        <Image
                      ...
                      <p
                        className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                      >
                        Works effectively on both light and dark backgrounds
                        while maintaining visual impact and brand recognition.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div>
                      <div className="bg-slate-950 rounded-xl p-6 mb-4">
                        ...
                        <p className="text-slate-300 text-sm mb-4">
                          Premium, sophisticated appearance ideal for energy and
                          technology sectors.
                        </p>
                      ...
                      <ul
                        className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm space-y-1`}
                      >
                    ...
                    <div>
                      <div className="bg-gray-50 rounded-xl p-6 mb-4 border border-gray-100">
                        ...
                        <p className="text-gray-700 text-sm mb-4">
                          Clean, accessible design perfect for documentation and
                          broad accessibility.
                        </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div
                    className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-6 text-center group ${isDarkMode ? "hover:bg-slate-800/80" : "hover:bg-gray-50"} transition-all duration-300`}
                  >
                    ...
                    <p
                      className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                    >
                      Environmentally responsible energy solutions that protect
                  ...
                  >
                    ...
                    <p
                      className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                    >
                      Empowering local entrepreneurs and villages with
                      accessible clean energy technology
                    </p>
                  </div>
                  <div
                    className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-6 text-center group ${isDarkMode ? "hover:bg-slate-800/80" : "hover:bg-gray-50"} transition-all duration-300`}
                  >
                    ...
                    <p
                      className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                    >
                      Cutting-edge technology and smart solutions for
                      comprehensive energy access
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="colors" className="space-y-8">
              <div>
                ...
                <p
                  className={`text-xl leading-relaxed mb-8 ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                >
                  Our color system follows the 60-30-10 rule to create visual
                  hierarchy and brand consistency across all touchpoints.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div
                    className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-6 group ${isDarkMode ? "hover:bg-slate-800/80" : "hover:bg-gray-50"} transition-all duration-300`}
                  >
                    <div
                      className="w-full h-40 rounded-xl mb-6 shadow-lg group-hover:scale-105 transition-transform duration-300"
                      style={{
                        backgroundColor: "rgb(61, 213, 109)",
                        boxShadow: "rgba(61, 213, 109, 0.125) 0px 10px 30px",
                      }}
                    />
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                      ...
                      <p
                        className={`text-sm leading-relaxed ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                      >
                        Primary brand color for CTAs, headers, and key brand
                        elements
                      </p>
                      <div className="space-y-2">
                        <button
                        ...
                        >
                          <span
                            className={`font-mono ${isDarkMode ? "text-slate-200" : "text-gray-700"}`}
                          >
                            #3DD56D
                          </span>
                          {copied === "hex" ? (
                            ...
                            <Copy
                              className={`w-4 h-4 ${isDarkMode ? "text-slate-400 group-hover:text-slate-300" : "text-gray-500 group-hover:text-gray-700"}`}
                            />
                          )}
                        </button>
                        <button
                          onClick={() =>
                            copyToClipboard("rgb(61, 213, 109)", "rgb")
                          }
                          className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                        >
                          <span
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard("hsl(142, 64%, 54%)", "hsl")
                          }
                          className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                        >
                          <span
                  ...
                  {/* Forest Green */}
                  <div
                    className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-6 group hover:${isDarkMode ? "bg-slate-800/80" : "bg-gray-50"} transition-all duration-300`}
                  >
                    <div
                      className="w-full h-40 rounded-xl mb-6 shadow-lg group-hover:scale-105 transition-transform duration-300"
                      style={{
                        backgroundColor: "rgb(43, 183, 87)",
                        boxShadow: "rgba(43, 183, 87, 0.125) 0px 10px 30px",
                      }}
                    />
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                      ...
                      <p
                        className={`text-sm leading-relaxed ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                      >
                        Secondary color for gradients, hover states, and
                        supporting elements
                      </p>
                      <div className="space-y-2">
                        <button
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard("rgb(43, 183, 87)", "rgb2")
                          }
                          className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                        >
                          <span
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard("hsl(139, 62%, 44%)", "hsl2")
                          }
                          className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                        >
                          <span
                  ...
                  >
                    <div
                      className="w-full h-40 rounded-xl mb-6 shadow-lg group-hover:scale-105 transition-transform duration-300"
                      style={{
                        backgroundColor: "rgb(35, 164, 85)",
                        boxShadow: "rgba(35, 164, 85, 0.125) 0px 10px 30px",
                      }}
                    />
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                      ...
                      <p
                        className={`text-sm leading-relaxed ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                      >
                        Accent color for highlights, badges, and special
                        emphasis
                      </p>
                      <div className="space-y-2">
                        <button
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard("rgb(35, 164, 85)", "rgb3")
                          }
                          className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                        >
                          <span
                        ...
                        <button
                          onClick={() =>
                            copyToClipboard("hsl(143, 65%, 39%)", "hsl3")
                          }
                          className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                        >
                          <span
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {/* Slate Dark */}
                  <div
                    className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-4 group hover:${isDarkMode ? "bg-slate-800/80" : "bg-gray-50"} transition-all duration-300`}
                  >
                    <div
                    ...
                    />
                    <h5
                      className={`font-bold text-sm ${isDarkMode ? "text-white" : "text-gray-900"} mb-2`}
                    >
                      Slate Dark
                    </h5>
                    <p
                      className={`${isDarkMode ? "text-slate-400" : "text-gray-600"} text-xs mb-3`}
                    >
                      Primary backgrounds
                    </p>
                    <button
            ...
            <section id="gradients" className="space-y-8">
              <div>
                ...
                <p
                  className={`text-xl leading-relaxed mb-8 ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                >
                  Our signature gradients and SVG patterns create depth and
                  visual interest while maintaining brand consistency.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Primary Gradient */}
                  <div
                    className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-6`}
                  >
                    <div
                      className="w-full h-32 rounded-xl mb-4"
                      style={{
                        background:
                          "linear-gradient(to right, #3DD56D, #2bb757)",
                      }}
                    />
                    <h4
                      className={`font-bold ${isDarkMode ? "text-white" : "text-gray-900"} mb-2`}
                    ...
                    <p
                      className={`text-sm ${isDarkMode ? "text-slate-400" : "text-gray-600"} mb-4`}
                    >
                      Primary buttons, hero elements
                    </p>
                    <button
                      onClick={() =>
                        copyToClipboard(
                    ...
                    >
                      <span
                        className={`font-mono text-xs ${isDarkMode ? "text-slate-200" : "text-gray-700"}`}
                      >
                        bg-gradient-to-r from-[#3DD56D] to-[#2bb757]
                      </span>
                      {copied === "primary-gradient" ? (
                        <Check className="w-4 h-4 text-green-500" />
                      ) : (
                        <Copy
                          className={`w-4 h-4 ${isDarkMode ? "text-slate-400 group-hover:text-slate-300" : "text-gray-500 group-hover:text-gray-700"}`}
                  ...
                  >
                    ...
                    <p
                      className={`text-sm ${isDarkMode ? "text-slate-400" : "text-gray-600"} mb-4`}
                    >
                      Page backgrounds, card containers
                    </p>
                    <button
                      onClick={() =>
                        copyToClipboard(
                  ...
                  >
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to bottom right, #2bb757, #23A455)",
                      }}
                    />
                    <h4
                      className={`font-bold ${isDarkMode ? "text-white" : "text-gray-900"} mb-2`}
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(
                          "bg-gradient-to-br from-[#2bb757] to-[#23A455]",
                          "accent-gradient",
                        )
                      }
                      className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                  ...
                  >
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #0f172a 0%, rgba(15, 23, 42, 0.8) 50%, transparent 100%)",
                      }}
                    >
                    ...
                    <p
                      className={`text-sm ${isDarkMode ? "text-slate-400" : "text-gray-600"} mb-4`}
                    >
                      Image overlays, content protection
                    </p>
                    <button
                      onClick={() =>
                        copyToClipboard(
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  >
                    <div
                      className={`w-full h-32 rounded-xl mb-4 relative overflow-hidden ${isDarkMode ? "bg-slate-900" : "bg-gray-100"}`}
                    >
                      <svg
                    ...
                    <h4
                      className={`font-bold ${isDarkMode ? "text-white" : "text-gray-900"} mb-2 text-sm`}
                    >
                      Dots Pattern
                    </h4>
                    <p
            ...
            <section id="typography" className="space-y-8">
              <div>
                ...
                <p
                  className={`text-xl leading-relaxed mb-8 ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                >
                  Our typography hierarchy ensures clear communication and brand
              ...
              <div className="space-y-8">
                {/* Display Typography */}
                <div
                  className={`rounded-lg border text-card-foreground shadow-sm ${containerClasses} p-8`}
                >
                  <h3
                  ...
                  <div className="space-y-6">
                    <div
                      className={`border-b ${isDarkMode ? "border-slate-700" : "border-gray-200"} pb-6`}
                    >
                      <div
                        className={`text-6xl md:text-7xl lg:text-8xl font-black leading-none ${isDarkMode ? "text-white" : "text-gray-900"} mb-4`}
                      >
                        GREAN WORLD
                      </div>
                      <div
                        className={`${isDarkMode ? "text-slate-400" : "text-gray-600"} text-sm`}
                      >
                    ...
                    >
                      <div
                        className={`text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight ${isDarkMode ? "text-white" : "text-gray-900"} mb-4`}
                      >
                    ...
                    <div>
                      <div
                        className={`text-3xl md:text-4xl lg:text-5xl font-bold leading-tight ${isDarkMode ? "text-white" : "text-gray-900"} mb-4`}
                      >
                ...
                >
                  ...
                  <div className="space-y-6">
                    ...
                    >
                      <div
                        className={`text-2xl font-bold leading-tight ${isDarkMode ? "text-white" : "text-gray-900"} mb-4`}
                      >
                    ...
                    >
                      <div
                        className={`text-xl font-semibold leading-relaxed ${isDarkMode ? "text-white" : "text-gray-900"} mb-4`}
                      >
                    ...
                    >
                      <div
                        className={`text-lg font-medium leading-relaxed ${isDarkMode ? "text-slate-300" : "text-gray-800"} mb-4`}
                      >
                        Body Large - Primary content and important descriptions
                        that need emphasis
                      </div>
                      <div
                        className={`${isDarkMode ? "text-slate-400" : "text-gray-600"} text-sm`}
                    ...
                    >
                      <div
                        className={`text-base leading-relaxed ${isDarkMode ? "text-slate-300" : "text-gray-700"} mb-4`}
                      >
                    ...
                    <div>
                      <div
                        className={`text-sm leading-relaxed ${isDarkMode ? "text-slate-400" : "text-gray-600"} mb-4`}
                      >
                        Body Small - Secondary information, captions, and
                        supporting details
                      </div>
                      <div
                        className={`${isDarkMode ? "text-slate-400" : "text-gray-600"} text-sm`}
            ...
            <section id="patterns" className="space-y-8">
              <div>
                ...
                <p
                  className={`text-xl leading-relaxed mb-8 ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                >
                  Our signature patterns add visual interest and brand
                  recognition to backgrounds and decorative elements.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-br from-transparent ${isDarkMode ? "to-slate-900/20" : "to-gray-100/20"}`}
                    />
                  </div>
                  <h4
                    className={`font-bold text-lg ${isDarkMode ? "text-white" : "text-gray-900"} mb-3`}
                  >
                    Dot Pattern
                  </h4>
                  <p
                    className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed mb-4`}
                  >
                    Subtle circular elements creating depth and texture for hero
                ...
                >
                  ...
                  <p
                    className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed mb-4`}
                  >
                    Flowing organic shapes representing energy movement and
                ...
                >
                  ...
                  <p
                    className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed mb-4`}
                  >
                    Technical precision pattern ideal for data sections and
                ...
                >
                  ...
                  <p
                    className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed mb-4`}
                  >
                    Concentric circles representing energy expansion and
                    community impact reach
                  </p>
                  <button
                    onClick={() =>
                      copyToClipboard(radialPattern, "radial-pattern")
                    }
                    className={`flex items-center gap-2 px-3 py-2 ${isDarkMode ? "bg-slate-800/50 hover:bg-slate-700/50" : "bg-gray-100 hover:bg-gray-200"} rounded-lg transition-colors text-sm group w-full`}
                  >
                    <span
            ...
            <section id="components" className="space-y-8">
              <div>
                ...
                <p
                  className={`text-xl leading-relaxed mb-8 ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                >
                  Official GREAN WORLD components with exact styling and
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <GreanCard pattern="dots" gradient>
                      <h4
                        className={`font-bold ${isDarkMode ? "text-white" : "text-gray-900"} mb-3`}
                      >
                        Dot Pattern Card
                      </h4>
                      <p
                        className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                      >
                        Card with official dot pattern background and gradient
                        overlay
                      </p>
                    </GreanCard>
                    <GreanCard pattern="waves" gradient>
                      ...
                      <p
                        className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                      >
                        Card with official wave pattern background and gradient
                        overlay
                      </p>
                    </GreanCard>
                    <GreanCard pattern="grid" gradient>
                      ...
                      <p
                        className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                      >
                        Card with official grid pattern background and gradient
                        overlay
                      </p>
                    </GreanCard>
                    <GreanCard pattern="radial" gradient>
                      ...
                      <p
                        className={`${isDarkMode ? "text-slate-300" : "text-gray-600"} text-sm leading-relaxed`}
                      >
                        Card with official radial pattern background and
                        gradient overlay
                      </p>
                    </GreanCard>
                  </div>
            ...
            <section id="usage" className="space-y-8">
              <div>
                ...
                <p
                  className={`text-xl leading-relaxed mb-8 ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                >
                  Best practices and implementation guidelines for maintaining
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <ul
                    className={`space-y-4 ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                  >
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span>
                        Use the primary green (#3DD56D) for main CTAs and brand
                        elements
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      <Check className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                      <span>
                        Use official patterns and gradients for visual
                        consistency
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                ...
                >
                  ...
                  >
                    <li className="flex items-start gap-3">
                      ...
                      <span>
                        Don't modify the official green color values or create
                        custom variations
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                    ...
                    <li className="flex items-start gap-3">
                      <Code className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                      <span>
                        Don't stretch, distort, or modify the official logo
                        proportions
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Code className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                      <span>
                        Don't mix unofficial fonts with the brand typography
                        system
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Code className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" />
                      <span>
                        Don't ignore accessibility guidelines for color contrast
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <section id="html-integration" className="space-y-8">
              <div>
                ...
                <p
                  className={`text-xl leading-relaxed mb-8 ${isDarkMode ? "text-slate-300" : "text-gray-700"}`}
                >
                  This brand guidelines page now includes 100% complete HTML
                  data integration from both light and dark mode source files,
                  ensuring perfect fidelity to the original design
                  specifications.
                </p>
              </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  >
                    ...
                    >
                      All styling from HTML data files integrated
                    </p>
                  </div>
                  <div
                    className={`p-4 rounded-lg ${isDarkMode ? "bg-slate-800" : "bg-gray-50"}`}
                  ...
                  >
                    ...
                    <p
                      className={`text-sm ${isDarkMode ? "text-slate-300" : "text-gray-600"}`}
                    >
                      All components and interactions preserved
                    </p>
                  </div>
                </div>
              </div>
