...
export function EnergyPillars() {
  ...
  const headingAnimation = useTypewriter(
  ...
  return (
    <section
      ref={ref}
      className="w-full max-w-7xl mx-auto py-16 sm:py-24 px-4 sm:px-6 lg:px-8 z-10 relative"
    >
      ...
      <div className="text-center mb-12 sm:mb-16">
        ...
        >
          ...
          <div className="min-h-[200px] sm:min-h-[240px] md:min-h-[280px] flex items-center justify-center mb-6">
            <h2
              className={`typography-display text-4xl sm:text-5xl md:text-6xl text-center ${
          ...
          <p
            className={`typography-body text-lg md:text-xl max-w-4xl mx-auto text-center ${
          ...
          >
            ...
            that transform communities and businesses across Ethiopia.
          </p>
        </div>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                />
                <div
                  className={`typography-small mt-2 transition-colors duration-300 ${
                    isDark
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div className="flex-1">
                    <h3
                      className={`typography-h3 mb-3 group-hover:text-[#3DD56D] transition-colors duration-300 ${
                        isDark ? "text-white" : "text-gray-900"
                      }`}
                    >
                      {pillar.title}
                ...
                <p
                  className={`typography-body mb-6 transition-colors duration-300 ${
                    isDark
                ...
                <div className="space-y-3">
                  {pillar.features.map((feature, featureIndex) => (
                    ...
                    >
                      ...
                      />
                      <span
                        className={`typography-small transition-colors duration-300 ${
                          isDark
                            ? "text-gray-400 group-hover:text-gray-300"
                            : "text-gray-600 group-hover:text-gray-700"
                        }`}
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 text-center space-y-4">
            <div
              className={`typography-h3 transition-colors duration-300 ${
                isDark
            ...
            <div
              className={`typography-body transition-colors duration-300 ${
                isDark
                  ? "text-gray-300 group-hover:text-gray-200"
                  : "text-gray-700 group-hover:text-gray-800"
              }`}
